        ...
        <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8 ac-text-optimized">
          ...
          {loading ? (
            <div className="text-center py-16">
              ...
              <p className="body-craft text-copper-700">Loading integrations...</p>
            </div>
          ) : error ? (
            <Motion preset="fadeIn" className="text-center py-16">
              <Card variant="outlined" className="max-w-md mx-auto border-red-200 bg-red-50">
                <CardContent className="p-8">
                  ...
                  <h3 className="heading-craft text-xl text-mahogany-800 mb-2">Connection Error</h3>
                  <p className="body-craft text-copper-700">{error}</p>
                </CardContent>
                <CardFooter>
                  <Button onClick={load} variant="accent" size="sm" shape="rounded" className="mx-auto">
                    Try Again
                  </Button>
                </CardFooter>
              </Card>
                ...
                <Card variant="elevated" interactive="hover" className="group h-full">
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-2">
                      <div className="p-3 bg-neutral-900 rounded-organic-craft">
                      ...
                      <div>
                        <CardTitle className="group-hover:text-copper-600 transition-colors">GitHub</CardTitle>
                        <CardDescription>OAuth connection for profile verification</CardDescription>
                      </div>
                    </div>
