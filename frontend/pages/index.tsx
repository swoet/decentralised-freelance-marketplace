    ...
    <AppShell>
      ...
      <div className="min-h-screen bg-white ac-animate-crisp">
        ...
        <section className="min-h-screen flex items-center justify-center relative overflow-hidden craft-gpu-accelerated">
          {/* Parallax Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-craft-mahogany-50 via-craft-copper-50 to-craft-gold-50"></div>
          
          {/* Floating Elements */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute w-4 h-4 bg-craft-gold-400 rounded-full opacity-20 craft-float" style={{left: '10%', top: '20%'}}></div>
            <div className="absolute w-3 h-3 bg-craft-copper-400 rounded-full opacity-30 craft-float" style={{left: '80%', top: '30%', animationDelay: '1s'}}></div>
            <div className="absolute w-5 h-5 bg-craft-mahogany-400 rounded-full opacity-20 craft-float" style={{left: '20%', top: '70%', animationDelay: '2s'}}></div>
            <div className="absolute w-2 h-2 bg-craft-gold-500 rounded-full opacity-40 craft-float" style={{left: '70%', top: '80%', animationDelay: '0.5s'}}></div>
          </div>
          
          <Motion preset="slideInDown" className="max-w-6xl mx-auto relative z-10 text-center px-4">
            {/* Subtitle Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-craft-gold-100 text-craft-gold-800 rounded-full text-sm font-medium mb-6 craft-shimmer-effect">
              <span className="w-2 h-2 bg-craft-gold-500 rounded-full animate-pulse"></span>
              🎨 New Platform Launch
            </div>
            
            {/* Main Title */}
            <h1 className="font-display font-bold text-6xl md:text-8xl text-craft-mahogany-800 mb-6 craft-typewriter">
              Welcome to <span className="text-craft-gold-600">CraftNexus</span>
            </h1>
            
            {/* Description */}
            <p className="font-body text-xl md:text-2xl text-craft-copper-700 max-w-4xl mx-auto leading-relaxed mb-10">
        ...
        <section className="max-w-7xl mx-auto px-4 py-20">
          ...
          <Motion preset="slideInUp" className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-craft-mahogany-800 mb-4">
              Discover Your <span className="text-craft-gold-600">Creative Path</span>
            </h2>
            <p className="font-body text-lg text-craft-copper-700 max-w-2xl mx-auto">
        ...
        <section className="max-w-4xl mx-auto px-4 py-20 bg-gradient-to-br from-craft-mahogany-50 to-craft-copper-50 rounded-3xl mx-4 craft-animate-crisp">
          <Motion preset="slideInUp" className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-craft-mahogany-800 mb-6">
              Choose Your <span className="text-craft-gold-600">Creative Path</span>
            </h2>
            <p className="font-body text-lg text-craft-copper-700 max-w-2xl mx-auto">
          ...
          <Stagger staggerDelay={200} className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Motion preset="scaleIn" transition={{ delay: 100 }}>
              <Card variant="filled" interactive="hover" className="text-center craft-card-hover craft-animate-crisp relative">
                <div className="craft-card-glow"></div>
                <CardHeader>
                  <div className="p-6 bg-gradient-to-br from-craft-mahogany-100 to-craft-mahogany-200 rounded-organic-craft mx-auto mb-6 w-fit craft-shimmer-effect">
                    <svg className="w-12 h-12 text-craft-mahogany-600" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v2H2v-4l4.257-4.257A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z" clipRule="evenodd"/>
                    </svg>
                  </div>
                  <CardTitle className="font-display text-2xl mb-3">Traditional Access</CardTitle>
                  <CardDescription className="text-craft-copper-600">Secure email and password authentication for instant access to your CraftNexus workspace.</CardDescription>
                </CardHeader>
                <CardFooter>
            ...
            <Motion preset="scaleIn" transition={{ delay: 200 }}>
              <Card variant="filled" interactive="hover" className="text-center craft-card-hover craft-animate-crisp relative">
                <div className="craft-card-glow"></div>
                <CardHeader>
                  <div className="p-6 bg-gradient-to-br from-craft-gold-100 to-craft-gold-200 rounded-organic-leaf mx-auto mb-6 w-fit craft-shimmer-effect craft-pulse-glow">
                    <svg className="w-12 h-12 text-craft-gold-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <CardTitle className="font-display text-2xl mb-3">Web3 Connection</CardTitle>
                  <CardDescription className="text-craft-copper-600">Connect your MetaMask or Web3 wallet for decentralized identity and blockchain-powered security.</CardDescription>
                </CardHeader>
                <CardFooter>
